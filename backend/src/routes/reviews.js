...
router.get('/product/:productId', (req, res) => {
  try {
    ...
    let reviews = getCollection('reviews').filter((r) => r.productId === req.params.productId);
    switch (sort) {
    ...
    const allReviews = getCollection('reviews').filter((r) => r.productId === req.params.productId);
